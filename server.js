...
app.post('/newCompany', async (req, res) => {
  ...
  allModels[_id + '_workers'] = mongoose.model(
    _id + '_workers',
    require('./mongo/schemas/dynamic/workers'),
    _id + '_workers'
  );
  allModels[_id + '_reports'] = mongoose.model(
    _id + '_reports',
    require('./mongo/schemas/dynamic/reports'),
    _id + '_reports'
  );
...
app.post('/newWorker', async (req, res) => {
  console.log(allModels[req.body._id + '_workers']);
